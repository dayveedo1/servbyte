package com.david.ServByte.config;
...
public class Myswaggerconfig {
    ...
    private ApiInfo metadata() {
        return new ApiInfoBuilder().title("Inventory API").description("API reference guide for developers").termsOfServiceUrl("https://www.google.com/").contact("Nandom").version("1.0").build();
    }
